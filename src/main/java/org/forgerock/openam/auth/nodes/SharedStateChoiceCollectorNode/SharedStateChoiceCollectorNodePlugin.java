 ...
 * @since AM 5.5.0
 */
public class SharedStateChoiceCollectorNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(SharedStateChoiceCollectorNodePlugin.currentVersion, 
				Collections.singletonList(SharedStateChoiceCollectorNode.class));
	}
	...
	public String getPluginVersion() {
		return SharedStateChoiceCollectorNodePlugin.currentVersion;
	}
}
